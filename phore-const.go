...
const (
	...
	CAppNameBoxPhore        string = "BoxPhore"
	CAppNameUpdaterBoxPhore string = "BoxPhore Updater"
	...
	CAppCLIFileWinBoxPhore          string = "boxphore.exe"
	CAppCLIFileInstallerBoxPhore    string = "boxphore-installer"
	CAppCLIFileInstallerWinBoxPhore string = "boxphore-installer.exe"
	CAppServerFileBoxPhore          string = "boxphores"
	CAppServerFileWinBoxPhore       string = "boxphores.exe"
	CAppUpdaterFileBoxPhore         string = "update-boxphore"
	CAppUpdaterFileWinBoxPhore      string = "update-boxphore.exe"
	CAppCLILogfileBoxPhore          string = "boxphore.log"
)
